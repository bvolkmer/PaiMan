package de.x4fyr.paiman.lib.adapter.database.conversions

import de.x4fyr.paiman.lib.adapter.database.Painting
import de.x4fyr.paiman.lib.adapter.database.toPropertiesMap
...
class PropertiesMapDomainConversionsTest {
    ...
    fun PaintingConversionNonNullTest() {
        ...
        val painting = de.x4fyr.paiman.lib.domain.Painting(
                ...
                tags = TAGS,
                mainPicture = MAIN_PICTURE, finished = FINISHED
        )
        //when
